...
class Board
  ...
  def detect_winner
    WINNING_LINES.each do |line|
      square1 = @squares[line[0]].marker
      square2 = @squares[line[1]].marker
      square3 = @squares[line[2]].marker
      return square1 if square1 == square2 && square2 == square3 && square1 != Square::INITIAL_MARKER
    end
    nil
  end
end
